<?php
namespace SJBR\SrSendcard\Mail;
...
class MailCard
{
	 ...
	 * Constructor
	 *
	 * @param AbstractPlugin $pibase
	 * @return void
	 */
	public function __construct(AbstractPlugin $pibase)
	{
	 ...
	 * @return void
	 */
	public function sendEmail(array $emailData, $emailTemplateKey)
	{
		$content = '';
		$htmlContent = '';
		// Get templates
	 ...
	 */
	protected function embedMedia(MailMessage $mail, $htmlContent)
	{
